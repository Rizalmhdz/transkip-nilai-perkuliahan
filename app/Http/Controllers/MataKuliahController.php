...
class MataKuliahController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('mata_kuliah.index', compact('mata_kuliahs', 'prodis', 'prodi_id', 'dosens', 'dosen_id', 'kategori_matkuls', 'kode_kategori', 'total', 'sort', 'direction', 'searchKeyword'));
    }
    ...
    public function create()
    {
        ...
        return view('mata_kuliah.create', compact('dosens', 'prodis', 'kategori_matkuls'));
    }
    ...
    public function edit(MataKuliah $mataKuliah)
    {
        ...
        return view('mata_kuliah.edit', compact('mataKuliah', 'dosens', 'prodis', 'kategori_matkuls'));
    }
